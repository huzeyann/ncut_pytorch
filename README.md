...
<details open="" class="details-reset border rounded-2">
  <summary class="px-3 py-2">
    ...
    <span aria-label="Video description video-reference+dinov2.mp4" class="m-1">video-reference+dinov2.mp4</span>
    <span class="dropdown-caret"></span>
  </summary>

  <video src="https://ncut-pytorch.readthedocs.io/en/latest/images/ncut_video_sam_264_small.mp4" data-canonical-src="https://ncut-pytorch.readthedocs.io/en/latest/images/ncut_video_sam_264_small.mp4" controls="controls" muted="muted" class="d-block rounded-bottom-2 border-top width-fit" style="max-height:640px; min-height: 200px">
