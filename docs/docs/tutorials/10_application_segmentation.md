...
> Legacy note: this page still uses removed helpers such as `NCUT`, `rgb_from_tsne_3d`, `ncut_pytorch.backbone`, and `get_mask`. Treat it as a historical notebook and use the current examples on the home page for current equivalents.
