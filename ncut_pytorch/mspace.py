...
class CompressionModel(pl.LightningModule):
    def __init__(self, in_dim, mood_dim=2, n_eig=32, n_layer=4, latent_dim=512, eigvec_loss=1, recon_loss=1, riemann_curvature_loss=0, axis_align_loss=0, repulsion_loss=0.01, boundary_loss=0.01, lr=0.001):
        super().__init__()
